export default function Home() {
    return (
        <div className='terms-of-use'>
            <article>
                <h1>1. Welcome to InstaDEX.Finance(“we,” “us,” or “our”)the informational resource for InstaDEX Protocol, as defined below.</h1>
                <p>Effective Date: December 1st, 2023</p>
                <p> InstaDEX.Finance provides information and resources about the fundamentals of the decentralized 
                    non-custodial liquidity protocol called the InstaDEX Protocol (the “InstaDEX Protocol” or “Protocol”). 
                    InstaDEX.Finance is not one of the available access points to the InstaDEX Protocol.
                </p>
                <p> ARBITRATION NOTICE: THESE TERMS (“TERMS”) CONTAIN AN ARBITRATION CLAUSE BELOW. EXCEPT FOR CERTAIN
                    ...
                    INCLUDE OUR VARIOUS WEBSITES, INCLUDING, WITHOUT LIMITATION, InstaDEX.Finance (AND ANY RESPECTIVE
                    ...
                    THESE TERMS, InstaDEX.Finance - PRIVACY POLICY (FOUND HERE), AND OTHER POLICIES REFERENCED HEREIN
                ...
                <p>
                    As a condition to accessing or using the Site or Interface, you represent and warrant to InstaDEX.finance the following:
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        jurisdiction over InstaDEX.finance or you as otherwise duly enacted, 
                ...
                <p>
                    ...
                    Services at contact@InstaDEX.finance. When you communicate with us electronically, you consent to
            ...
            <article>
                <h2>InstaDEX.Finance is provided as an informational resource.</h2>
                <p>InstaDEX.Finance provides resources about the fundamentals of the 
                    InstaDEX Protocol, which is a fully decentralized, community governed 
                    protocol deployed on multiple blockchain networks and systems, and 
                    provides information about the wider InstaDEX ecosystem, governance, 
                    community, and various interfaces and integrations to the InstaDEX 
                    ...
                    resource. Because the Site provides information about the InstaDEX 
                ...
                <h2>We are software developers in the InstaDEX Protocol ecosystem.</h2>
                <p>
                    It is important to understand that neither we nor any affiliated entity is a party to any
                    transaction on
                    the blockchain networks underlying the InstaDEX Protocol; we do not have possession, custody or
                    control
                    ...
                    when
                    you interact with any InstaDEX Protocol smart contracts, you retain control over your cryptoassets
                    at
                ...
                <h2>
                    The InstaDEX Protocol is deployed on multiple blockchain-based networks, and we are not responsible
                    for
                    the operation of such networks.
                </h2>
                <p> The software underlying blockchain networks on which the InstaDEX Protocol is deployed, including,
                    for
                    ...
                    operation of the blockchain-based software and networks underlying the InstaDEX Protocol, (ii) that
                ...
                <h2>InstaDEX Ecosystem and Community contributors are independent.</h2>
                <p>All community contributors to the ecosystem around the InstaDEX Protocol are independent of us, and
                    we
            ...
            <article>
                ...
                <p>Transactions on the InstaDEX Protocol rely on smart contracts stored on various blockchains,
                ...
                <p>
                    ...
                    that you will not seek to hold any InstaDEX.Finance Party responsible for any
                    consequent
                    losses.
                </p>
            ...
            <article>
                ...
                <p>
                    ...
                    materials that you may access or use on or through the Services; however, the code for the InstaDEX
                    Protocol
                    and the front-end interface (app.InstaDEX.finance) deployed on IPFS is open-sourced. Except as
                    expressly set
            ...
            <article>
                ...
                <p>
                    ...
                    EMPLOYEES,
                    AGENTS, REPRESENTATIVES, PARTNERS, AND LICENSORS (COLLECTIVELY, THE “InstaDEX.Finance INDEMNIFIED
                    PARTIES”)
                    MAKE NO GUARANTEES OF ANY KIND IN CONNECTION WITH THE SERVICES. TO THE MAXIMUM EXTENT PERMITTED
                    UNDER
                    APPLICABLE LAW, THE InstaDEX.Finance INDEMNIFIED PARTIES DISCLAIM ALL WARRANTIES AND CONDITIONS,
                    WHETHER
                ...
                <ul>
                    ...
                    <li>
                        ...
                        THAT
                        THE InstaDEX.Finance INDEMNIFIED PARTIES ARE NOT RESPONSIBLE FOR LOSS OR DAMAGE CAUSED BY
                        ANOTHER
                ...
                <p>
                    Limitation of Liability. TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL ANY InstaDEX.Finance
                ...
                <p>
                    IN ADDITION TO THE FOREGOING, NO InstaDEX.Finance INDEMNIFIED PARTY SHALL BE LIABLE FOR ANY
                    DAMAGES
                    CAUSED
                ...
                <p>
                    ...
                    WHETHER OR
                    NOT THE InstaDEX.Finance INDEMNIFIED PARTIES HAVE BEEN INFORMED OF THE POSSIBILITY OF ANY SUCH
                    DAMAGE.
                </p>
                <p>
                    IN NO EVENT WILL THE InstaDEX.Finance INDEMNIFIED PARTIES’ CUMULATIVE LIABILITY TO YOU OR ANY
                    OTHER
                    USER,
                ...
                <p>
                    UNDER NO CIRCUMSTANCES SHALL ANY InstaDEX.Finance INDEMNIFIED PARTY BE REQUIRED TO DELIVER TO YOU
                    ANY
                ...
                <p>
                    ...
                    to
                    you. To the extent applicable law does not permit InstaDEX.Finance Indemnified Parties to
                    disclaim
                    certain
                    warranties or limit certain liabilities, the extent of InstaDEX.Finance Indemnified Parties’
                    liability and
            ...
            <article>
                ...
                <p>You agree to indemnify, defend, and hold harmless the InstaDEX.Finance Indemnified Parties from
                    any
                    claim or
            ...
            <article>
                ...
                <p>
                    ...
                    consent to
                    any InstaDEX.Finance Indemnified Party, or to its successors in the interest of any business
                    associated
            ...
            <article>
                ...
                <p>
                    ...
                    The Agreement (including, without limitation, these Terms, and the InstaDEX.Finance Privacy
                    Policy)
                    and any
